...
To set up the intlayer editor, you must follow the [intlayer editor documentation](/doc/concept/editor).

To set up the intlayer CMS, you must follow the [intlayer CMS documentation](/doc/concept/cms).
