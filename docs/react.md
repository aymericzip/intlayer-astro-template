...
> By default, the routes are not prefixed for the default locale. If you want to prefix the default locale, you can set the `middleware.prefixDefault` option to `true` in your configuration. See the [configuration documentation](/doc/concept/configuration) for more information.
...
const { localeMap } = require("intlayer"); // Utility functions and types from 'intlayer'
