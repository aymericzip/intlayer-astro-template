...
> To Learn more about the `useIntlayer` hook, refer to the [documentation](/doc/packages/react-intlayer/useIntlayer) (The API is similar for `preact-intlayer`).
...
> To Learn more about the `useLocale` hook, refer to the [documentation](/doc/packages/react-intlayer/useLocale) (The API is similar for `preact-intlayer`).
...
> By default, the routes are not prefixed for the default locale. If you want to prefix the default locale, you can set the `routing.mode` option to `"prefix-all"` in your configuration. See the [configuration documentation](/doc/concept/configuration) for more information.
